...
import { sections } from "@/assets/data/privacyData";
      ...
      <section className="gradient-hero relative py-12 md:py-20 lg:py-12 px-4 overflow-hidden">
        ...
        <div className="md:container px-4 mx-auto relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">Your Privacy Matters</h1>
        ...
        <div className="md:container mx-auto max-w-4xl">
          <Card className="mb-8 border-primary/20 bg-primary/5">
            <CardContent className="pt-6">
              <p className="text-lg">
                At TalentCanvas, we believe in transparency and respect for your privacy. This policy explains how we collect, use, and protect your
