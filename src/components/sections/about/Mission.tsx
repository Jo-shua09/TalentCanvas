        ...
        <div className="container mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Our AI-powered platform ensures that every candidate gets matched with roles that truly fit their skills, and every application
                receives meaningful feedback. No more guessing games.
              </p>
